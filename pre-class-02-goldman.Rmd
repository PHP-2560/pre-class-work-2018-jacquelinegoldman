...
hist(columnMeans)
```
The histogram is normally distributed. Though the distribution that generated the means is exponential, after creating a matrix with 1,000 columns, comprising of 1,100 rows, the column means become normally distributed. 
